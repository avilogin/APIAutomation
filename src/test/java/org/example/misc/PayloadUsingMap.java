...
public class PayloadUsingMap {
    ...
    public void nonBDDCreateBooking()
    {
        ...
        //using HashMap we will be creating the payload
        //As we are using hashmap so the request we are sending will be in random order

        Map<String, Object> jsonBody = new HashMap<>();//took first argument as string as its string and 2nd as Object as for different keys we have different types of values
